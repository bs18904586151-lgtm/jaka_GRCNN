...
```
python train_network.py --description training_pretrained_modelpwd --use-dropout 0 --input-size 300
...
```bash
python evaluate.py --network "trained-models/jacquard-d-grconvnet3-drop0-ch32/epoch_50_iou_0.94" --dataset jacquard --data-path '/media/baig/硬盘Y/Jacquard' --iou-eval --input-size 300 --use-rgb 0
```
